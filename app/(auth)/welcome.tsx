...
const Onboarding = () => {
    ...
    return (
        <SafeAreaView className="flex h-full items-center justify-between bg-white">
           <Pressable onPress={()=>{router.replace("/(auth)/sign-up")}} className="w-full flex justify-end items-end p-5">
            ...
            <Swiper
                ...
                activeDot={<View className="w-[32px] h-[4px] mx-1 bg-[#028FFF] rounded-full" />}
